namespace _6_Lab {
    ...
    struct Task_1_1 {
        ...
        public Task_1_1(string surname, string society, double[] results) {
            this.surname = surname;
            this.society = society;
            this.score = results.Max();
        }
    }
    ...
    struct Task_1_4 {
        ...
        public Task_1_4(string surname, double[] results) {
            this.surname = surname;
            this.score = results.Max();
        }
    }
    ...
    class Program {
        static void Main(string[] args) {
            ...
            static void task_1_1() {
                ...
                Task_1_1[] sportsmen = new Task_1_1[n];

                Console.WriteLine("Sportsmen names, society and results, example: Ivanov BIVT-22-17 2,41 2,37");
                for (int i = 0; i < n; i++) {
                    Console.Write($"{i + 1}. ");
                    ...
                    for (int j = 2; j < 4; j++) {
                        if (!double.TryParse(data[j], out results[j - 2])) {
                            Console.WriteLine("Wrong input.");
                            return;
                        }
                        if (results[j - 2] < 0) {
                    ...
                    sportsmen[i] = new Task_1_1(data[0], data[1], results);
                }

                for (int i = 0; i < n; i++) {
                    for (int j = i + 1; j < n; j++) {
                        if (sportsmen[i].score < sportsmen[j].score) {
                            Task_1_1 temp = sportsmen[j];
                ...
                for (int i = 0; i < n; i++) {
                    Task_1_1 temp = sportsmen[i];
                    Console.WriteLine($"{i + 1}. {temp.surname}\t{temp.society}\t{temp.score}");
                }
            }
            ...
            static void task_1_4() {
                ...
                Task_1_4[] sportsmen = new Task_1_4[n];

                Console.WriteLine("Sportsmen names, society and results, example: Ivanov 2,41 2,37");
                for (int i = 0; i < n; i++) {
                    Console.Write($"{i + 1}. ");
                    ...
                    sportsmen[i] = new Task_1_4(data[0], results);
                }

                for (int i = 0; i < n; i++) {
                    for (int j = i + 1; j < n; j++) {
                        if (sportsmen[i].score < sportsmen[j].score) {
                            Task_1_4 temp = sportsmen[j];
                            sportsmen[j] = sportsmen[i];
                            sportsmen[i] = temp;
                        }
                    }
                ...
                Console.WriteLine("Scoreboard");
                for (int i = 0; i < n; i++) {
                    Task_1_4 temp = sportsmen[i];
                    Console.WriteLine($"{i + 1}. {temp.surname}\t{temp.score}");
                }
            }
